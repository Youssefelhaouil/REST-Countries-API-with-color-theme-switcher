...
const Countries = ({ isDark, countries }) => {
    ...
    return (
        <>
            <Filter searchCountries={searchCountries} searchInput={searchInput}></Filter>

            {
                searchInput.length > 0 ? <div className="grid grid-cols-4 md:flex md:flex-wrap px-[80px] gap-10 rounded-md pt-10">
            ...
            </div> : <div className="grid grid-cols-4 md:flex md:flex-wrap px-[80px] gap-10 rounded-md pt-10">
